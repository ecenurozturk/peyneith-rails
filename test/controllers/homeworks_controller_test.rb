...
class HomeworksControllerTest < ActionController::TestCase
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post :create, homework: { content: @homework.content, end_time: @homework.end_time, lesson_id: @homework.lesson_id, start_time: @homework.start_time, subject: @homework.subject }
    end
  ...
  test "should update homework" do
    patch :update, id: @homework, homework: { content: @homework.content, end_time: @homework.end_time, lesson_id: @homework.lesson_id, start_time: @homework.start_time, subject: @homework.subject }
    assert_redirected_to homework_path(assigns(:homework))
  end
